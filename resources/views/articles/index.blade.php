                ...
                <div class="px-3 py-3 mb-2 shadow rounded bg-white">
                    ...
                    <form id="blog-search-form" action="">
                        <div class="flex border bg-gray-100 rounded overflow-hidden focus-within:border-primary">
                            <input type="text" name="s" value="" placeholder="Type keyword here..." id="blog-search-el" autocomplete="off" spellcheck="false" class="grow shadow-inner caret-primary bg-transparent border-0 rounded-l focus:outline-none focus:ring-transparent" />
                ...
                <div class="sticky top-16">
                    <div class="mb-3 shadow rounded-md bg-white">
                        ...
                        <div class="flex flex-col">
                            <a href="" class="inline-flex truncate px-3 py-2 border-b w-full justify-between gap-2 hover:text-primary-500 hover:bg-primary-50">
                                <span class="inline-block truncate">Category 1 Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti illo voluptates beatae, quasi. Ut dolore suscipit quasi asperiores commodi autem. Corporis laboriosam eum repudiandae incidunt aliquid perferendis aperiam voluptatibus, unde.</span>
                                <span>(23)</span>
                            </a>
                            <a href="" class="inline-flex px-3 py-2 border-b w-full justify-between gap-2 hover:text-primary-500 hover:bg-primary-50">
