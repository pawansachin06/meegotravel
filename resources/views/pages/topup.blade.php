    ...
    <section class="relative py-5">
        <div class="md:container px-3 py-5 flex flex-wrap justify-center">
            <div class="w-full md:w-11/12 lg:w-11/12 xl:w-9/12 2xl:w-7/12 mb-8 text-center">
                <small class="inline-block px-3 py-1 mb-3 rounded-full text-base font-semibold bg-primary-100 text-primary-500">Best Place to Buy eSIM Topups</small>
                <h1 class="text-3xl md:text-4xl lg:text-5xl !leading-snug mb-3 font-bold">Buy Travel eSIMs Topups</h1>
                ...
                <div class="max-w-2xl mx-auto">
                    <div class="flex mb-2 justify-between">
                        <div class="">
                            <select class="py-1 text-sm rounded-md focus:border-primary-500 focus:ring-primary-200">
                                <option value="all">All</option>
                                <option value="3">3</option>
                                <option value="ubigi">Ubigi</option>
                                <option value="annatel">Annatel</option>
                                <option value="esimgo">eSIMGo</option>
                                <option value="sparks">Sparks</option>
                                <option value="airalo">Airalo</option>
                            </select>
                        </div>
                        <div class="">
                            <label class="flex items-center select-none gap-2 cursor-pointer border-primary-400">
                                <span class="leading-none text-sm">
                                    Country
                                </span>
                                <span class="relative">
                                    <input type="checkbox" id="inputViewMap" name="showMap" class="input-switch sr-only" />
                                    <div class="block bg-gray-300 border-1 border-gray-400 hover:border-primary-400 w-14 h-6 rounded-full"></div>
                                    <div class="input-switch-dot absolute left-1 top-0 bg-white w-6 h-6 ring-4 ring-primary-100 shadow rounded-full transition"></div>
                                </span>
                            </label>
                        </div>
                    </div>
