    ...
    <div class="py-3">
        <div class="lg:container px-3">
            <div class="mb-3 flex flex-wrap justify-between items-center">
                ...
                <div class="">
                    <form action="{{ route('settings.store') }}" method="post" data-js="app-create-form">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="px-3 py-2">
                                        <div class="inline-flex flex flex-wrap gap-1 justify-end">
                                            <x-button href="{{ route('settings.edit', $item->id) }}">Edit</x-button>
                                            <form action="{{ route('settings.destroy', $item->id) }}" method="post" data-js="app-delete-form">
                                                @method('DELETE')
