<x-app-layout>
    <div x-data="{
        ...
        <div @keydown.escape.prevent.stop="qr_installation_modal_open = false" x-show="qr_installation_modal_open" class="fixed top-0 left-0 bottom-0 right-0 w-full h-full overflow-hidden" role="dialog" aria-modal="true" style="z-index:11;">
        ...
        <div @keydown.escape.prevent.stop="manual_installation_modal_open = false" x-show="manual_installation_modal_open" class="fixed top-0 left-0 bottom-0 right-0 w-full h-full overflow-hidden" role="dialog" aria-modal="true" style="z-index:11;">
            <div class="relative h-full flex items-end mx-auto px-3 max-w-2xl w-auto">
